class Question {
    ...
    this.question.html("Who was the first computer programmer?");
    this.question.position(100,30);
    this.option1.html("1: Grace Hopper");
    this.option1.position(150,60);
    this.option2.html("2: Ada Lovelace");
    this.option2.position(150,100);
    this.option3.html("3: Margaret Hamilton");
    this.option3.position(150,140);
    this.option4.html("4: Ken Thompson");
